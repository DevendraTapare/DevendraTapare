...
### AI Engineer · Full-Stack AI Products · LLM Applications
...
I'm an **AI Engineer** focused on building **full-stack AI products** — from intelligent backends powered by LLMs to seamless user-facing interfaces. I work at the intersection of machine learning, language models, and software engineering to ship AI that actually works in production.

- 🔭 Currently building: Full-stack AI applications & LLM-powered tools
- 🧠 Exploring: Agents, RAG pipelines, fine-tuning & multi-modal models
- 🛠️ Stack: Python · LangChain · OpenAI API · HuggingFace · PyTorch · TensorFlow
- 📍 Based in India
- 💬 Ask me about: Prompt engineering, LLM integration, AI product design
...
> *Projects coming soon — currently building & shipping!*

| Project | Description | Stack | Status |
|--------|-------------|-------|--------|
| 🔜 LLM App | Intelligent assistant powered by OpenAI & LangChain | Python, LangChain, FastAPI | 🔨 In Progress |
| 🔜 RAG Pipeline | Retrieval-augmented generation system for document Q&A | HuggingFace, FAISS, FastAPI | 🔨 In Progress |
| 🔜 AI Dashboard | Full-stack AI product with model integration & UI | Python, React, OpenAI | 🔨 Planned |
...
- 🔍 **Advanced RAG** — Hybrid search, re-ranking, and chunking strategies
- ☁️ **MLOps** — Model deployment, monitoring, and CI/CD for AI systems
...
I'm always open to collaborating on AI projects, discussing ideas, or just talking about what's happening in the LLM space.

> **"Build AI products that solve real problems — not just demos."**
